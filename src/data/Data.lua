...
ITEM[3] = {key=3,pic="icon/icon11/box.png",name="带绳箱子",appear=true,ifcontain = true,inname="box",tishi="箱子",tishi="被绳子系住的盒子，绳子很紧，需要东西割开。"}
ITEM[4] = {key=4,pic="icon/icon11/elegant_easyicon.png",name="护身符",appear=true,ifcontain = true,inname="elegant_easyicon",tishi="和贝诺特利的国徽相同、具有奥拉汀女神标志的护身符。"}
...
ITEM[16] = {key=16,pic="icon/icon11/redflower.png",name="红色花朵",appear=true,ifcontain = true,inname="redflower",use = false,tishi="被刷成红色的花朵，不知怎的看起来有些让人不舒服。"}
...
ITEM[30] = {key=30,pic="icon/icon12/qinghua.png",name="绿花",appear=true,ifcontain = true,inname="qinghua",tishi="绿色的花朵。"}
ITEM[31] = {key=31,pic="icon/icon12/zihua.png",name="紫花",appear=true,ifcontain = true,inname="zihua",tishi="紫色的花朵。"}
ITEM[32] = {key=32,pic="icon/icon12/fenhua.png",name="粉色花",appear=true,ifcontain = true,inname="fenhua",tishi="粉色的花朵。"}
...
ITEM[40] = {key=40,pic="icon/icon12/flower_ring.png",name="花环",appear=true,ifcontain = true,inname="flower_ring",tishi="好看的花环，如果送给别人应该没有人会不喜欢的。"}
...
FURNITURE[7] = {inname = "wardrobe",bool = true ,num = 1,ifchangesprite = false}
...
FURNITURE[14] = {inname = "phone",bool = true ,num = 1}
FURNITURE[15] = {inname = "Big_frame",bool = true ,num = 1,ifchangesprite=false}
